...
for i = 1:totalTransformations
    boolTranslation = 1;
    [originalImage, translatedImage] = ImageTransformations(imagePath, translations(i,:), boolTranslation);
    misalignedPatches = extractSimilarPosPatches(originalImage, translatedImage, patchSize, noOfSample);    
